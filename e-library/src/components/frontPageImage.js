            ...
            <div id="carouselExampleSlidesOnly" className="carousel back slide" data-ride="carousel">
                <div className="webContext">
                    ...
                    <div className="webTheme">
                        ...
                        aperiam necessitatibus, officiis nostrum voluptatem dolore, quidem officia cumque molestias sed saepe?
                        Ea, rerum inventore.
                    </div>
                    <div className="btns">
                        <a className="exloreBtn btn btn-warning" href="#booksContainer">Exlore The New World</a>
                    </div>
                </div>
            </div>
        </>
