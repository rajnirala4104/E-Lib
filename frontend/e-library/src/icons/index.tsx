...
export const SearchIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg
      stroke="currentColor"
...
export const UserIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg
      className={props.classes}
      stroke="currentColor"
...
export const RightArrowIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg
      className={props.classes}
...
export const LeftArrowIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg
      className={props.classes}
...
export const StarIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg
      className={props.classes}
...
export const CartIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg
      className={props.classes}
      stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
  )
}

export const HeartIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg
      className={props.classes}
...
export const LoadingSpinnerIcon: React.FC<IconClasses> = (props) => {
  return (
    <svg

      className={`animate-spin h-5 w-5 text-white ${props.classes}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
