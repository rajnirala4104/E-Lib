  ...
  return (
    <Fragment>
      <Suspense fallback={"loading..."}>
        <div 
          onClick={() => navigator(`/admin/${props.navigato}`)}
          className="border border-gray-100 h-full cursor-pointer flex justify-evenly items-center py-2 px-2 rounded-md shadow-md hover:shadow-lg">
